...
def generate_plots(drop_ratio_dict, loop_ratio_dict, filename):
        ...
        ax.legend((rects_cgfp_bgp_drop[0], rects_cgfp_bgp_loop[0], rects_cgc_bgp_drop[0], rects_cgc_bgp_loop[0], rects_sfp_drop[0], rects_sfp_loop[0]),
...
if __name__ == '__main__':
    ...
    for policy_type in policy_types:
        ...
        for filename in filenames:
            ...
            drop_ratio_dict[ratio]['SFP on CGFP-BGP Reachable Flows'] = final[filename]['SFP on CGFP-BGP Reachable Flows'].drop_ratio()
            ...
            loop_ratio_dict[ratio]['SFP on CGFP-BGP Reachable Flows'] = final[filename]['SFP on CGFP-BGP Reachable Flows'].loop_ratio()
